          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-7">
              <div className="space-y-4">
                {/* BADGE */}
                <div className="inline-flex items-center gap-2 px-4 p-2 bg-gradient-to-r from-primary/10 to-primary/5 rounded-full border border-primary/20 backdrop-blur-sm">
            ...
            <div className="relative lg:pl-8">
              ...
              <Image src="/hero.png" width={420} height={420} alt='DentWise AI' className='max-w-md h-auto' />
            </div>
          </div>
        </div>
      </div>
