        ...
        <div className="mb-12 overflow-hidden">
          <div className="flex items-center justify-between bg-gradient-to-br from-primary/10 to-background rounded-3xl p-8 border border-primary/20">
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Get unlimited AI consultations, advance features, and priority
            ...
            <div className="hidden lg:block">
              <div className="size-32 bg-gradient-to-br from-primary/20 to-primary/10 rounded-full flex items-center justify-center">
