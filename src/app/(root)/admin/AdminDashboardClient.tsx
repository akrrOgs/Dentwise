...
import { useGetAppointments } from "@/hooks/useAppoinment";
...
const AdminDashboardClient = () => {
  ...
  const stats = {
    ...
    compleatedAppointments: appointments.filter(
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 pt-24">
        ...
        <div className="mb-12 flex items-center justify-between bg-gradient-to-br from-primary/10 to-primary/5 bg-background rounded-3xl p-8 border border-primary/20">
        ...
        <AdminStats
          ...
          compleatedAppointments={stats.compleatedAppointments}
        />
